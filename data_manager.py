...
class VCM(object):
    root = '/media/yangxilab/DiskB/wxian/dataset/VCM-HITSZ/'
    # training data
    ...
    def _process_data_train(self,names,meta_data,relabel=False,min_seq_len=0):
        ...
        for tracklet_idx in range(num_tracklets):
            ...
            if m == 1:
                ...
                # img_ir_paths = [osp.join(self.root,'TrainSam', decoder_pic_path(img_name)) for img_name in img_names]
                ...
                # img_rgb_paths = [osp.join(self.root,'TrainSam', decoder_pic_path(img_name)) for img_name in img_names]
